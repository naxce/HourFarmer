...
namespace HourFarmer
{
    ...
    {
        private const string __LOCAL_VERSION = "2026.1.1";
        private const string __ONLINE_VERSION_URL = "https://pastebin.com/raw/XwH8WKqM";
        public string version = __LOCAL_VERSION;
